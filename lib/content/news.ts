...
// progress, Nairobi Coffee Exchange auction direction, freight and transit to
...
const en: Copy = {
  ...
  metaDescription:
    "Dated notes for green buyers: main crop progress and volumes, Nairobi Coffee Exchange price direction, freight and transit to Black Sea and Baltic ports, cup quality on the 2025/26 crop and when to book.",
  ...
  notes: [
    {
      ...
      paras: [
        `Space out of Mombasa for December and January loading is already being taken. Our forwarders are quoting USD ${range(2600, 3100, "en")} per 20' dry container to Novorossiysk and USD ${range(3200, 3900, "en")} to St Petersburg — around ${num(12, "en")}% above where the same slots booked in March, with the Red Sea security surcharge still attached.`,
    ...
    },
    {
      ...
      paras: [
        `Yesterday's sale carried ${num(16200, "en")} bags, one of the larger catalogues of the season, and still cleared almost completely. AA from the Central Kenya mills went at USD ${range(400, 470, "en")} per ${num(50, "en")} kg bag, AB from the same lots at USD ${range(300, 350, "en")}, and PB traded at a ${range(5, 8, "en")}% discount to AB.`,
        `Two things are driving it. Global arabica remains historically expensive, so buyers working on differentials are less price-sensitive than usual. And the main crop we called at ${range(50000, 53000, "en")} t in December has come in near the bottom of that range, at about ${num(50800, "en")} t clean.`,
  ...
  ctaTitle: "Ask for the numbers behind a note",
  ctaLede:
...
const ru: Copy = {
  ...
  metaDescription:
    "Датированные заметки для закупщиков: ход основного урожая и объёмы, направление цен на аукционе в Найроби, фрахт и сроки доставки в порты Чёрного и Балтийского морей, качество чашки текущего урожая и когда бронировать отгрузку.",

  eyebrow: "Обзор рынка · сезон 2025/26",
  h1: "Рынок кенийского кофе: сезон 2025/26",
  heroLede:
    "Короткие датированные заметки о том, что действительно влияет на закупку: как идёт сбор, по каким ценам уходят лоты на аукционе в Найроби, что происходит с фрахтом и сроками доставки в Новороссийск и Санкт-Петербург и как текущий урожай ведёт себя на каппинг-столе.",

  listEyebrow: "Сначала свежие",
  listTitle: "Шесть заметок за сезон",
  listLede:
    "Мы публикуем заметку тогда, когда меняется что-то, способное повлиять на решение о закупке: сбор сдвинулся, торги ушли выше ожиданий, на линии стало тесно с местами. Старые заметки остаются без правок — по ним видно, как сезон разворачивался на самом деле, а не как он выглядит задним числом.",
  ...
  notes: [
    {
      ...
      paras: [
        `Места из Момбасы под загрузку в декабре и январе разбирают уже сейчас. Экспедиторы дают ${range(2600, 3100, "ru")} долларов за 20-футовый контейнер до Новороссийска и ${range(3200, 3900, "ru")} до Санкт-Петербурга — примерно на ${num(12, "ru")} % выше, чем те же слоты стоили в марте, и с сохранением надбавки за проход Красного моря.`,
    ...
    },
    {
      date: "2026-07-14",
      tag: "Аукцион",
      title: "Сезон закрылся: AA держится, AB — лучшее соотношение цены и чашки",
      paras: [
        `Во вторник Nairobi Coffee Exchange провёл последние торги сезона 2025/26: в каталоге было около ${num(8400, "ru")} мешков против ${range(14000, 18000, "ru")} мешков, которые уходили в феврале. Тонкий каталог в конце сезона обычно означает крепкие цены — так и вышло: AA из Ньери и Кириньяги ушёл по ${range(385, 455, "ru")} долларов за мешок ${num(50, "ru")} кг, AB с тех же моек — по ${range(305, 360, "ru")}.`,
        `За сезон AA прибавил к прошлому примерно ${num(9, "ru")} %, AB — около ${num(6, "ru")} %. Разрыв между грейдами не сузился, а вырос: конкуренция шла за размер сита под моносорта, а не за баллы в чашке.`,
        `Вывод на ближайшие месяцы: AB с той мойки, чей AA вам уже нравится, — самая выгодная позиция на доске. Тот же день сбора, та же ферментация, те же сушильные столы: минус ${range(1, 2, "ru")} балла в чашке и минус треть в цене. Там, где важнее профиль, а не размер зерна, мы предпочтём поставить AB, а разницу пустить на фрахт и отдых партии.`,
      ],
    },
    {
      date: "2026-06-09",
    ...
    },
    {
      ...
      paras: [
        `Вчерашние торги собрали ${num(16200, "ru")} мешков — один из крупнейших каталогов сезона — и разошлись почти полностью. AA с моек Центральной Кении уходил по ${range(400, 470, "ru")} долларов за мешок ${num(50, "ru")} кг, AB из тех же партий — по ${range(300, 350, "ru")}, PB торговался с дисконтом ${range(5, 8, "ru")} % к AB.`,
        `Причин две. Мировая арабика остаётся исторически дорогой, поэтому покупатели, работающие на дифференциалах, менее чувствительны к цене, чем обычно. И основной урожай, который в декабре мы оценивали в ${range(50000, 53000, "ru")} т, вышел ближе к нижней границе — около ${num(50800, "ru")} т чистого кофе.`,
        `Тем, кто ещё не закрыл кенийскую позицию на этот год: дешевле до промежуточного урожая не станет, а промежуточный урожай серьёзную программу не закроет. Закрывайте подтверждённую потребность сейчас и не трогайте спекулятивные объёмы.`,
      ],
    },
    {
      date: "2025-12-02",
  ...
  ctaTitle: "Спросите цифры, которые стоят за заметкой",
  ctaLede:
    "За каждой цифрой выше стоит конкретный лот, торги или букинг, в которых мы участвовали. Если какая-то из них важна для вашего решения, покажем первоисточник: аукционный лист, каппинг-форму или ставку экспедитора.",
  disclaimerLabel: "Ориентировочно, не торговая рекомендация.",
  disclaimerText:
    "Это наши собственные наблюдения — с моек, с аукционных торгов и от букинг-отдела наших экспедиторов. Цены, объёмы и сроки указаны ориентировочно, меняются от недели к неделе и не являются офертой, котировкой или торговой рекомендацией. Твёрдую цену на конкретный грейд и отгрузочное окно мы даём отдельным предложением.",
